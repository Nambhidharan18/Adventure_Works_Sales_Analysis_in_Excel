...
To analyze and summarize profit based on:
...
The dataset was obtained from the author’s shared Google Drive (from the tutorial).
It includes **six related tables**:
